...
@testset "Callbacks" begin
    ...
    @testset "Neutron star hot spots" begin
        ...
        @test Skylight.star_cartesian_coordinates_condition(u, 0.0, integrator) ≈
              (rmax^2 - 100) * 75
        @test Skylight.star_spherical_coordinates_condition(u, 0.0, integrator) ≈
              (rmax - 10) * 5.0
    ...
    @testset "Black hole accretion disk" begin
        model = DummyDisk(inner_radius = 6.0, outer_radius = 15.0)
        ...
        cbp = Skylight.callback_parameters(spacetime,
            model,
            configurations,
            rhorizon_bound = 1e-6)
        ...
        Skylight.spinning_black_hole_accretion_disk_cartesian_coordinates_condition(out,
            u,
            0.0,
            integrator)
        ...
        Skylight.black_hole_accretion_disk_spherical_coordinates_condition(out,
            u,
            0.0,
            integrator)
        ...
        Skylight.spinning_black_hole_accretion_disk_cartesian_coordinates_affect!(integrator,
            1)
