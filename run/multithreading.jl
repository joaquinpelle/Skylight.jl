...
function time_intensities(; N, tasks_per_thread)
    ...
    println("N = $N")
    println("Serial")
    @time _ = Skylight.observed_bolometric_intensities_serial(initial_data,
        output_data,
        configurations,
        camera)
    println("Multithread")
    @time _ = observed_bolometric_intensities(initial_data,
        output_data,
        configurations,
        camera;
        tasks_per_thread = tasks_per_thread)
    println("Multithread tmap")
    @time _ = Skylight.observed_bolometric_intensities_tmap(initial_data,
        output_data,
        configurations,
        camera;
        tasks_per_thread = tasks_per_thread)
...
function test_intensities(; N, tasks_per_thread)
    ...
    output_data = run.output_data
    println("N = $N")
    Iobs = observed_bolometric_intensities(initial_data,
        output_data,
        configurations,
        camera;
        tasks_per_thread = tasks_per_thread)
    Itmap = Skylight.observed_bolometric_intensities_tmap(initial_data,
        output_data,
        configurations,
        camera;
        tasks_per_thread = tasks_per_thread)
...
function btime_intensities(; N, tasks_per_thread)
    ...
    println("N = $N")
    println("Serial")
    @btime _ = Skylight.observed_bolometric_intensities_serial($initial_data,
        $output_data,
        $configurations,
        $camera)
    println("Multithread")
    @btime _ = observed_bolometric_intensities($initial_data,
        $output_data,
        $configurations,
        $camera;
        tasks_per_thread = $tasks_per_thread)
    println("Multithread tmap")
    @btime _ = Skylight.observed_bolometric_intensities_tmap($initial_data,
        $output_data,
        $configurations,
        $camera;
        tasks_per_thread = $tasks_per_thread)
