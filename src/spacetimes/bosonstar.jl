...
function BosonStarSpacetime(name::Symbol)
    ...
    elseif name==:ABS6
        ...
        b = [0.103834, -38.5692, 47.4598, -29.7192, 7.13655, -1.24035, 73.4475, -77.6181, -4.55463, 79.3582,  -71.1497, 32.3825, -7.25857, 1.04383]

    elseif name==:ABS7

        a = [-4.77687, 10.2226, -15.8701, 25.4614,
            -32.6696, 19.4165, 1.21693, 
            -5.74852, 10.5152, -7.13708, 
            -8.55168, 34.4711, -51.6148, 
            31.3627]
        b = [-0.0241447, -2.99339, 20.0759, 
        -51.8587, 61.9027, -28.8333, 1.14578,
        -8.35491, 22.229, -15.7265, 
        -46.9879, 126.614, -124.038, 
        46.2127]

    elseif name==:ABS8

        a = [-8.19255, 30.601, -87.0478, 251.755, 
        -543.378, 526.173, 1.20896, -9.73192,
        29.9852, -31.2102, -97.5369, 
        589.825, -1436.43, 1414.25]
        b = [-0.00137507, -0.238901, 2.73024, 
        -11.8566, 23.5836, -18.1604, 
        0.0328394, -0.412244, 1.89926, 
        -2.54445, -9.85526, 47.2122, 
        -77.9392, 48.314]
