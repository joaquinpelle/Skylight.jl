...
c = 2.99792458e10         #Speed of light in CGS                      (exact)
c2 = 8.98755178737e20     #Squared speed of light in CGS              (exact)    
h = 6.62607015e-27        #Planck constant in CGS  6.626 070 15       (exact)
...
#ce = 1.602176634e-20     #Electron charge in emu-CGS (a relic, just in case)    (exact)
G = 6.6743015e-8          #Newton gravitational constant in CGS
M_sun = 1.988414e33       #Solar mass in CGS
