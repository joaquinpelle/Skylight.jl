...
geometrized_to_CGS(magnitude, dim, configurations::Configurations) = magnitude*geometrized_unit_magnitude_in_CGS(dim; M1=configurations.unit_mass_in_solar_masses)
CGS_to_geometrized(magnitude, dim, configurations::Configurations) = magnitude/geometrized_unit_magnitude_in_CGS(dim; M1=configurations.unit_mass_in_solar_masses)
