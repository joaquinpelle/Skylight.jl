...
function callback(::AbstractBlackHoleSpacetime, ::VerticalScreen, ::CartesianTopology)
    screen_behind_black_hole_callback()
end

function screen_behind_black_hole_callback()
    VectorContinuousCallback(screen_behind_black_hole_condition,
        screen_behind_black_hole_affect!,
        2)
end
